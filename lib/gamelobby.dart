                            ...
                            child:  Container(
                                ...
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    FadeAnimation(1, Text("vs", style: TextStyle(
                                        fontSize: 18,
                                        fontWeight: FontWeight.w400
                                    ),)),
                                    Row(
                                    ...
                                    SizedBox(height: 20,),
                                    FadeAnimation(1.3, Text("Game Date : 20th June 2020", style: TextStyle(
                                        fontSize: 15,
                                        fontWeight: FontWeight.w400
                                    ),)),
                                    SizedBox(height: 10,),
                    ...
                    child: Container(
                        ...
                        child:  Container(
                            ...
                            child: Column(
                              children: <Widget>[
                                SizedBox(height: 10,),
                                FadeAnimation(1.3, Text("Pass the Cup Game- Code", style: TextStyle(
                                    fontSize: 18,
                                    fontWeight: FontWeight.w400
                                ),)),
                                SizedBox(height: 10,),
                                FadeAnimation(1, Text("3J9C5F", style: TextStyle(
                                    fontSize: 25,
                    ...
                    child: Container(
                        ...
                        child:  Container(
                            ...
                            child: Column(
                              children: <Widget>[
                                SizedBox(height: 10,),
                                FadeAnimation(1, Text("Players in Lobby", style: TextStyle(
                                    fontSize: 18,
                                    fontWeight: FontWeight.w400
                                ),)),
                                SizedBox(height: 10,),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: <Widget>[
                                    FadeAnimation(1.3, Text("1.", style: TextStyle(
                                        fontSize: 20,
                                ...
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: <Widget>[
                                    FadeAnimation(1.3, Text("2.", style: TextStyle(
                                        fontSize: 20,
                                        fontWeight: FontWeight.w600
                                    ),)),
                                    SizedBox(width: 10,),
                                ...
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: <Widget>[
                                    FadeAnimation(1.3, Text("3.", style: TextStyle(
                                        fontSize: 20,
                                        fontWeight: FontWeight.w600
                                    ),)),
                                    SizedBox(width: 10,),
                                ...
                                FadeAnimation(1.4, Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: FlatButton.icon(
                                      ...
                                      label: Text("Invite Friends", style: TextStyle(
                                          fontWeight: FontWeight.w600,
                                          fontSize: 18
                                      ),),
                                    ),
